...
- page (welke pagina gegevens opgevraagd wordt, als er meerdere pagina's aan gegevens zijn - zie ook [niet-functionele eisen](non-functionals.md), default de eerste pagina)
...
Naast de vroegsignalen worden gegevens voor de paginering meegegeven. Deze zijn nodig als niet alle vroegsignalen in één responsebericht passen - zie de [niet-functionele eisen](non-functionals.md) voor meer uitleg.
