...
- [Klik hier om het bestand te downloaden](https://raw.githubusercontent.com/VNG-Realisatie/ddas-vroegsignalering/refs/heads/main/v1.2/DDAS-VS.yaml)  
...
Conform de specificaties voor de bestandsuitwisseling voor [vroegsignalering](https://vng-realisatie.github.io/ddas-vroegsignalering/latest/uitwisselspecificatie/), is de encoding van de berichten UTF-8.
...
- aanleverendeOrganisatie (string - organisatie waarvan de gegevens geleverd worden, default alle; alleen relevant als over meer dan 1 organisatie (gemeente/ schuldhulpverlener) gegevens aangeleverd worden)
...
- pageSize (integer - aantal records (vroegsignalen) dat in één responsebericht meegestuurd wordt, default leeg: gegevensleverancier bepaalt dan het aantal met een maximum zoals bepaald in de [niet-functionele eisen](non-functionals.md#performance))
...
De payload is gebaseerd op het uitwisselformaat zoals dat is beschreven voor [vroegsignaleringsgegevens](https://vng-realisatie.github.io/ddas-vroegsignalering/v1.2/uitwisselspecificatie/).
