...
# Data delen voor Armoede en Schulden: Vroegsignalering
...
In de folder met de verschillende versies vind je de schema's van de uitwisselspecificatie voor DDAS in het kader van vroegsignalering.  

Kijk voor toelichting op de [documentatie website](https://vng-realisatie.github.io/ddas-vroegsignalering/).
